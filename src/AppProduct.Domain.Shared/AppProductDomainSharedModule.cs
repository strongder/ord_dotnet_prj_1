...
public class AppProductDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AppProductGlobalFeatureConfigurator.Configure();
        AppProductModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AppProductDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AppProductResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AppProduct");

            options.DefaultResourceType = typeof(AppProductResource);
        ...
        {
            options.MapCodeNamespace("AppProduct", typeof(AppProductResource));
        });
    }
}
